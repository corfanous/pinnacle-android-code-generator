...
public class ${classSpecification.name}ViewModel extends AndroidViewModel{
    ...
    public void init(long id){
        m${classSpecification.name}=${classSpecification.name?uncap_first}Repo.get${classSpecification.name}(id);
    }
    ...
    public LiveData<${classSpecification.name}> get(){
         return m${classSpecification.name};
    }
